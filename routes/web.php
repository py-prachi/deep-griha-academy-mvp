...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/reports/bulk-receipt',                 [App\Http\Controllers\FeeReportController::class, 'storeBulkReceipt'])->name('reports.bulkReceipt.store');
    Route::delete('/reports/bulk-receipt/{id}',          [App\Http\Controllers\FeeReportController::class, 'deleteBulkReceipt'])->name('reports.bulkReceipt.delete');
