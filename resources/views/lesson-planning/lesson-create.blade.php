                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('lesson-planning.lessons.store') }}" id="lesson-form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-rich-textarea name="chapter_topic" :value="old('chapter_topic')" :min-height="140" />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-rich-textarea name="learning_standard" :value="old('learning_standard')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Objective</label>
                                    <x-rich-textarea name="objective" :value="old('objective')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Material Needed</label>
                                    <x-rich-textarea name="material_needed" :value="old('material_needed')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Training Component</label>
                                    <x-rich-textarea name="training_component" :value="old('training_component')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Student to Whom Responses Expected</label>
                                    <x-rich-textarea name="student_responses" :value="old('student_responses')" :min-height="140" />
                                </div>

                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Hook</label>
                                        <x-rich-textarea name="hook" :value="old('hook')" :min-height="150" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Teach</label>
                                        <x-rich-textarea name="teach" :value="old('teach')" :min-height="150" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <x-rich-textarea name="guided_practice" :value="old('guided_practice')" :min-height="150" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Independent Practice (CW)</label>
                                        <x-rich-textarea name="independent_practice" :value="old('independent_practice')" :min-height="150" />
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Closure</label>
                                    <x-rich-textarea name="closure" :value="old('closure')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Homework</label>
                                    <x-rich-textarea name="homework" :value="old('homework')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Any Other Note</label>
                                    <x-rich-textarea name="other_notes" :value="old('other_notes')" :min-height="140" />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Remark</label>
                                    <x-rich-textarea name="remark" :value="old('remark')" :min-height="140" />
                                </div>
