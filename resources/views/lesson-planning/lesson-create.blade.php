                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('lesson-planning.lessons.store') }}" id="lesson-form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="chapter_topic" rows="2" class="form-control @error('chapter_topic') is-invalid @enderror">{{ old('chapter_topic') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="learning_standard" rows="2" class="form-control @error('learning_standard') is-invalid @enderror">{{ old('learning_standard') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="objective" rows="2" class="form-control @error('objective') is-invalid @enderror">{{ old('objective') }}</textarea>
                                    @error('objective')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Material Needed</label>
                                    <textarea name="material_needed" rows="2" class="form-control @error('material_needed') is-invalid @enderror">{{ old('material_needed') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="training_component" rows="2" class="form-control @error('training_component') is-invalid @enderror">{{ old('training_component') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="student_responses" rows="2" class="form-control @error('student_responses') is-invalid @enderror">{{ old('student_responses') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="hook" rows="3" class="form-control @error('hook') is-invalid @enderror">{{ old('hook') }}</textarea>
                                        @error('hook')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Teach</label>
                                        <textarea name="teach" rows="3" class="form-control @error('teach') is-invalid @enderror">{{ old('teach') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="guided_practice" rows="3" class="form-control @error('guided_practice') is-invalid @enderror">{{ old('guided_practice') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="independent_practice" rows="3" class="form-control @error('independent_practice') is-invalid @enderror">{{ old('independent_practice') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="closure" rows="2" class="form-control @error('closure') is-invalid @enderror">{{ old('closure') }}</textarea>
                                    @error('closure')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Homework</label>
                                    <textarea name="homework" rows="2" class="form-control @error('homework') is-invalid @enderror">{{ old('homework') }}</textarea>
                                    @error('homework')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Any Other Note</label>
                                    <textarea name="other_notes" rows="2" class="form-control @error('other_notes') is-invalid @enderror">{{ old('other_notes') }}</textarea>
                                    @error('other_notes')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Remark</label>
                                    <textarea name="remark" rows="2" class="form-control @error('remark') is-invalid @enderror">{{ old('remark') }}</textarea>
