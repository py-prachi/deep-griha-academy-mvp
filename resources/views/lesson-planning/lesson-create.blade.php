                ...
                <div class="col ps-4 pe-4">
                    ...
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb small">
                            ...
                            <li class="breadcrumb-item active">Add Lesson Plan</li>
                        </ol>
                    </nav>

                    <h4 class="mb-1"><i class="bi bi-journal-richtext me-1"></i> Add Lesson Plan</h4>
                    ...
                    <div class="card shadow-sm" style="max-width:900px;">
                        <div class="card-body">
                            <form method="POST" action="{{ route('lesson-planning.lessons.store') }}" id="lesson-form">
                                @csrf
                                        ...
                                        <div class="d-flex gap-4 mt-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="module_required" id="mod_no" value="0"
                                                       {{ old('module_required', '0') == '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="module_required" id="mod_yes" value="1"
                                                       {{ old('module_required') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="mod_yes">Yes</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6" id="module-select-wrapper" style="{{ old('module_required') == '1' ? '' : 'display:none;' }}">
                                        ...
                                        <select name="module_id" class="form-select @error('module_id') is-invalid @enderror">
                                            ...
                                            <option value="{{ $mod->id }}" {{ old('module_id') == $mod->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="chapter_topic" rows="6" style="min-height:140px;" class="form-control @error('chapter_topic') is-invalid @enderror">{{ old('chapter_topic') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="period_timing" class="form-control @error('period_timing') is-invalid @enderror"
                                           value="{{ old('period_timing') }}" placeholder="e.g. 9:00–9:40 AM">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="learning_standard" rows="6" style="min-height:140px;" class="form-control @error('learning_standard') is-invalid @enderror">{{ old('learning_standard') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="objective" rows="6" style="min-height:140px;" class="form-control @error('objective') is-invalid @enderror">{{ old('objective') }}</textarea>
                                    @error('objective')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Material Needed</label>
                                    <textarea name="material_needed" rows="6" style="min-height:140px;" class="form-control @error('material_needed') is-invalid @enderror">{{ old('material_needed') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="training_component" rows="6" style="min-height:140px;" class="form-control @error('training_component') is-invalid @enderror">{{ old('training_component') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="student_responses" rows="6" style="min-height:140px;" class="form-control @error('student_responses') is-invalid @enderror">{{ old('student_responses') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="hook" rows="6" style="min-height:150px;" class="form-control @error('hook') is-invalid @enderror">{{ old('hook') }}</textarea>
                                        @error('hook')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Teach</label>
                                        <textarea name="teach" rows="6" style="min-height:150px;" class="form-control @error('teach') is-invalid @enderror">{{ old('teach') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="guided_practice" rows="6" style="min-height:150px;" class="form-control @error('guided_practice') is-invalid @enderror">{{ old('guided_practice') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="independent_practice" rows="6" style="min-height:150px;" class="form-control @error('independent_practice') is-invalid @enderror">{{ old('independent_practice') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="closure" rows="6" style="min-height:140px;" class="form-control @error('closure') is-invalid @enderror">{{ old('closure') }}</textarea>
                                    @error('closure')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Homework</label>
                                    <textarea name="homework" rows="6" style="min-height:140px;" class="form-control @error('homework') is-invalid @enderror">{{ old('homework') }}</textarea>
                                    @error('homework')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Any Other Note</label>
                                    <textarea name="other_notes" rows="6" style="min-height:140px;" class="form-control @error('other_notes') is-invalid @enderror">{{ old('other_notes') }}</textarea>
                                    @error('other_notes')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Remark</label>
                                    <textarea name="remark" rows="6" style="min-height:140px;" class="form-control @error('remark') is-invalid @enderror">{{ old('remark') }}</textarea>
                                    @error('remark')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="d-flex gap-2 mt-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check-circle me-1"></i> Save Lesson Plan
                                    </button>
