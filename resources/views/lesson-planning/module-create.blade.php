                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('lesson-planning.modules.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="learning_outcome" rows="3" class="form-control @error('learning_outcome') is-invalid @enderror">{{ old('learning_outcome') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="assessment" rows="2" class="form-control @error('assessment') is-invalid @enderror">{{ old('assessment') }}</textarea>
                                    @error('assessment')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Rubric</label>
                                    <textarea name="rubric" rows="2" class="form-control @error('rubric') is-invalid @enderror">{{ old('rubric') }}</textarea>
                                    @error('rubric')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Objectives</label>
                                    <textarea name="objectives" rows="2" class="form-control @error('objectives') is-invalid @enderror">{{ old('objectives') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="materials" rows="2" class="form-control @error('materials') is-invalid @enderror">{{ old('materials') }}</textarea>
