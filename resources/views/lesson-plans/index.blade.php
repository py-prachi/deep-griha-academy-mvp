        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <h4 class="mb-1"><i class="bi bi-journal-text me-1"></i> Lesson Plans</h4>
                    ...
                    <h6 class="text-uppercase text-muted small fw-bold mb-2 border-bottom pb-1">
                        <i class="bi bi-pencil-square me-1"></i> My Lesson Plans
                    </h6>
                    ...
                    @if($ctPlans && $ctPlans->isNotEmpty())
                        ...
                        @endforeach
                    @else
                        <div class="alert alert-light text-muted">No lesson plan entries have been added for your class yet.</div>
                    @endif
                    @endif
