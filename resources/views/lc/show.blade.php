            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr><td class="text-muted">Admission No.</td><td>{{ ($lc->admission ? $lc->admission->dga_admission_no : '—') ?? '—' }}</td></tr>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr><td class="text-muted">Issued By</td><td>{{ ($lc->issuedBy ? $lc->issuedBy->name : '—') ?? '—' }}</td></tr>
