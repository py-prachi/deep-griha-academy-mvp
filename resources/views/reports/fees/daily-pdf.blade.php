...
<head>
    ...
    <style>
        ...
        .box { border: 1px solid #999; border-radius: 4px; padding: 8px 16px; text-align: center; flex: 1; }
...
<body>
    <div class="header">
        ...
        <h4>Daily Collection Report — {{ \Carbon\Carbon::parse($date)->format('d M Y') }}</h4>
    </div>
    ...
    <table>
        <thead>
            <tr>
                <th>Challan</th><th>Student Name</th><th>Class</th><th>Category</th><th>Mode</th><th class="text-end">Amount ₹</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr><td colspan="5" class="text-end">Total Collected</td><td class="text-end">₹{{ number_format($total, 2) }}</td></tr>
        </tfoot>
    </table>
