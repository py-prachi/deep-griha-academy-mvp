            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <div class="container-fluid px-0">
                        <form method="GET" action="{{ route('reports.fees.categorySummary') }}" class="mb-3">
                        ...
                        <div class="alert alert-warning d-flex align-items-center">
                            ...
                            <div>
                                Fee structure has not been set up for <strong>{{ $selectedSession ? $selectedSession->session_name : 'this session' }}</strong>.
                                This report will show ₹0.00 for all dues until fee structures are configured.
                                <a href="{{ route('fee-structures.index') }}" class="alert-link ms-2">Set up Fee Structures →</a>
                            </div>
                        </div>
                        @endif
