...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Deep Griha Academy | School Management System</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <h1 class="text-gray-900 dark:text-white" style="display:flex; align-items:center;">
                        <!-- <img src="{{asset('favicon_io/android-chrome-512x512.png')}}" class="mr-3" height="60" width="60"> -->

                        <div>
                            <div style="font-size: 42px; font-weight: 700; color:#1a202c;">
                                Deep Griha Academy
                            </div>
